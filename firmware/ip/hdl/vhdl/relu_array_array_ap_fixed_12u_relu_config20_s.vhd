...
entity relu_array_array_ap_fixed_12u_relu_config20_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of relu_array_array_ap_fixed_12u_relu_config20_s is 
    ...
    signal tmp_data_V_417_reg_664 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_data_V_5_reg_670 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                tmp_data_V_417_reg_664 <= data_V_data_4_V_dout;
                tmp_data_V_5_reg_670 <= data_V_data_5_V_dout;
    ...
    icmp_ln1494_4_fu_504_p2 <= "1" when (signed(tmp_data_V_417_reg_664) > signed(ap_const_lv16_0)) else "0";
    icmp_ln1494_5_fu_509_p2 <= "1" when (signed(tmp_data_V_5_reg_670) > signed(ap_const_lv16_0)) else "0";
    ...
    res_V_data_4_V_din <= 
        tmp_data_V_417_reg_664 when (icmp_ln1494_4_fu_504_p2(0) = '1') else 
        ap_const_lv16_0;
    ...
    res_V_data_5_V_din <= 
        tmp_data_V_5_reg_670 when (icmp_ln1494_5_fu_509_p2(0) = '1') else 
        ap_const_lv16_0;
